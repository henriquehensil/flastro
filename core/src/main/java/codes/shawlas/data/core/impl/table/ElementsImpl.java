...
import codes.shawlas.data.core.exception.column.DuplicatedColumnException;
import codes.shawlas.data.core.exception.column.InvalidColumnException;
import codes.shawlas.data.core.exception.column.DuplicatedKeyValueException;
import codes.shawlas.data.core.exception.column.MissingKeyException;
import codes.shawlas.data.core.exception.table.TableStateException;
import codes.shawlas.data.core.table.Column;
import codes.shawlas.data.core.table.Element;
import codes.shawlas.data.core.table.Table;
import codes.shawlas.data.core.table.TableData;
